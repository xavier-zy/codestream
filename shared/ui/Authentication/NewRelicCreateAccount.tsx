...
import { DialogRow } from "../Stream/Onboard";
...
export const NewRelicCreateAccount = (props: Props) => {
			...
			<form className="standard-form" onSubmit={onSubmit}>
				<fieldset className="form-body" style={{ paddingTop: 0, paddingBottom: 0 }}>
					{(!limitAuthentication || authenticationProviders["email"]) && (
						<div className="border-bottom-box" style={{ maxWidth: "none" }}>
							<h3>Free access to all of New Relic. Forever.</h3>
							<p className="explainer">No credit card required.</p>
							...
							<div id="controls">
								...
								<Button className="row-button" onClick={onSubmit} loading={isSubmitting}>
									<Icon name="newrelic" />
									<div className="copy">Start now</div>
							...
							<div className="small-spacer" />
							<div className="small-spacer" />
							<h3> With your new account, you get:</h3>
							<div className="small-spacer" />
							<div className="small-spacer" />
							<DialogRow>
								<Icon name="check" />
								<div>
									<b style={{ color: "var(--text-color-highlight" }}>Perpetually free access</b>
									<br />
									100 GB/month of free data ingest. 1 free full access user. Unlimited free basic
									users.
								</div>
							</DialogRow>
							<DialogRow>
								<Icon name="check" />
								<div>
									<b style={{ color: "var(--text-color-highlight" }}>
										One data platform for all metrics, logs, events, and traces
									</b>
									<br />
									Petabyte scale. Millisecond speed. Pennies per gigabyte (beyond free tier).
								</div>
							</DialogRow>
							<DialogRow>
								<Icon name="check" />
								<div>
									...
									<br />
									APM, Infrastructure Monitoring, Digital Experience Monitoring, Applied
