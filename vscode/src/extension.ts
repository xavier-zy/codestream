...
// 	constructor() {
// 		this.regex = /NewRelic\.([a-zA-Z_]+)\((["']\w+["'])\)/g;
...
// 					new vscode.CodeLens(
// 						range,
// 						new Foo(matches[2], "codestream.instrumentationOpen", [
...
// 	// 	console.log(token);
// 	// 	codeLens.command = {
// 	// 		title: "Found NewRelic method",
// 	// 		tooltip: "Tooltip provided by sample extension",
// 	// 		command: "codestream.instrumentationOpen",
// 	// 		arguments: ["Argument 1", false]
// 	// 	};
// 	// 	return codeLens;
// 	// }
// }
// class Foo implements vscode.Command {
// 	title: string = "";
// 	command: string = "";
// 	tooltip?: string | undefined;
// 	arguments?: any[] | undefined;
// 	constructor(t: string, c: string, args?: any[] | undefined) {
// 		this.title = t;
// 		this.command = c;
// 		this.arguments = args;
// 	}
