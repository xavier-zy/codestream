...
export const PixieDynamicLoggingCancelRequest = new RequestType<PixieDynamicLoggingCancelRequest, void, void, void>(
...
export const PixieDynamicLoggingResultNotification = new NotificationType<PixieDynamicLoggingEventNotification, void>(
